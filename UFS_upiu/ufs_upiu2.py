...
if __name__ == "__main__":
    ...
    # 将 CommandUPIU 实例转化为字节
    cmd_upiu_bytes = cmd_upiu.to_bytes()
    print("\nCommandUPIU 转化为字节:")
    print(cmd_upiu_bytes)

    # 从字节创建 CommandUPIU 实例
    new_cmd_upiu = CommandUPIU.from_bytes(cmd_upiu_bytes)
    print("\n从字节创建的 CommandUPIU 实例:")
    print(new_cmd_upiu)
